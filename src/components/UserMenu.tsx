      ...
      {open && (
        ...
        >
          ...
          <button
            role="menuitem"
            onClick={toggleTheme}
            className="w-full flex items-center gap-3 px-2.5 py-2.5 rounded-[13px] text-left hover:bg-surface2 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset"
          >
